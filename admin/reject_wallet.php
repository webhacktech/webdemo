...
$stmt = $conn->prepare("UPDATE vendor_wallets SET status = 'rejected' WHERE id = ?");
...
$action = "Rejected USDT wallet ID $wallet_id";
...
header("Location: admin_wallets.php?success=rejected");
exit();
?>